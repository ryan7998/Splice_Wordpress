...
/**
 * Splice WordPress Theme functions and definitions
 *
...
function splice_theme_setup()
{
     ...
     */
    load_theme_textdomain('splice-theme', get_template_directory() . '/languages');
    ...
    add_theme_support(
        'custom-background',
        apply_filters(
            'splice_theme_custom_background_args',
            array(
 ...
 */
function splice_theme_content_width()
{
    $GLOBALS['content_width'] = apply_filters('splice_theme_content_width', 1200);
}
add_action('after_setup_theme', 'splice_theme_content_width', 0);
 ...
 */
function splice_theme_widgets_init()
{
    register_sidebar(
        array(
            'name'          => esc_html__('Sidebar', 'splice-theme'),
            'id'            => 'sidebar-1',
            'description'   => esc_html__('Add widgets here.', 'splice-theme'),
    ...
    register_sidebar(
        array(
            'name'          => esc_html__('Footer Widget Area', 'splice-theme'),
            'id'            => 'footer-1',
            'description'   => esc_html__('Add footer widgets here.', 'splice-theme'),
...
add_action('widgets_init', 'splice_theme_widgets_init');
...
function splice_theme_scripts()
{
    ...
    wp_enqueue_style('splice-theme-fonts', 'https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap', array(), null);
